...
def main():
    ...
    print('len training: {} '.format(len(train_dataset)))
    ...
    if os.path.isdir(model_args.model_name_or_path):
        logger.info("Loading model from local path %s", model_args.model_name_or_path)
        trainer.train()
    else:
        logger.info("Loading model from Hub %s", model_args.model_name_or_path)
        trainer.train(
